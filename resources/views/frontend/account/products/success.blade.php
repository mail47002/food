...
@section('content')
    ...
    <div class="container text-center">
        ...
        <a href="{{ route('account.adverts.create', ['type' => 'by_date', 'pid' => $product->id]) }}" class="button-rectang"><i class="fo fo-time fo-2x"></i>Страва на дату</a>
        <a href="{{ route('account.adverts.create', ['type' => 'in_stock', 'pid' => $product->id]) }}" class="button-rectang"><i class="fo fo-dish-ready fo-2x"></i>Готова страва</a>
        <a href="{{ route('account.adverts.create', ['type' => 'pre_order', 'pid' => $product->id]) }}" class="button-rectang"><i class="fo fo-deal fo-2x"></i>Страва під замовлення</a>
