...
@section('content')
	...
	<div class="container">
		<ul class="list-inline">
			<li><a href="{{ route('account.articles.index') }}" class="link-blue back text-upper"><i class="fo fo-arrow-left fo-small"></i>  Назад до статей</a></li>

			<div class="pull-right">
				<a href="{{ route('account.advices.edit', $advice->id) }}" class="link-blue"><i class="fo fo-edit fo-inheirt"></i> Редагувати</a>
			</div>
		</ul>
	</div>
</div>
