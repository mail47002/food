...
class AdvertsController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($products) {
            ...
            return view('frontend.profile.adverts.create', [
                'products' => $products,
                'stickers' => $stickers
            ]);
        }
    ...
    public function success()
    {
        if (Session::has('advert')) {
            return view('frontend.profile.adverts.success', [
                'advert' => Session::get('advert')
            ]);
        }

        return redirect()->route('profile.adverts.index');
    }
    ...
    public function edit($id)
    {
        ...
        if ($advert) {
            ...
            return view('frontend.profile.adverts.edit', [
                'advert'   => $advert,
                'stickers' => $stickers
            ]);
        }
